-- =============================================
-- Script: Find All Views Using Target Columns
-- Purpose: Discover all views that reference File_Code, Doc_Code, Doc_Name, Doc_Path, Doc_Upload
-- =============================================
...
PRINT '=========================================='
PRINT 'VIEWS USING TARGET COLUMNS'
PRINT '=========================================='
PRINT ''

-- Find all views containing target columns
SELECT DISTINCT
...
-- Summary count
SELECT 
    COUNT(DISTINCT o.name) AS [Total_Affected_Views]
FROM 
    sys.objects o
INNER JOIN 
    sys.sql_modules m ON o.object_id = m.object_id
