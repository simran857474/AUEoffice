        ...
        return f.Client.prototype = {
            ...
            function (n, t, r) {
                ...
                TableTools.prototype = {
                    ...
                    fnGetSelectedIndexes: function (n) {
                        var r = [],
                            ...
                            t, i;
                        if (n)
                            for (t = 0, i = f.length; t < i; t++) u[f[t]]._DTTT_selected && r.push(f[t]);
                        else
                            for (t = 0, i = u.length; t < i; t++) u[t]._DTTT_selected && r.push(t);
                        return r
                    },
                    ...
                    _fnGetMasterSettings: function () {
                        ...
                        for (t = TableTools._aInstances, n = 0, i = t.length; n < i; n++)
                        ...
                        if (this.s.master) {
                            ...
                            n(i.nTBody).on("click.DTTT_Select", this.s.custom.sRowSelector, function (r) {
                                ...
                                if (u.parentNode == i.nTBody && i.oInstance.fnGetData(u) !== null) {
                                    if (e.type == "os")
                                        if (r.ctrlKey || r.metaKey) t.fnIsSelected(u) ? t._fnRowDeselect(u, r) : t._fnRowSelect(u, r);
                                        else if (r.shiftKey) {
                    ...
                    _fnColumnTargets: function (t) {
                        ...
                        if (typeof t == "function")
                            for (s = t.call(this, o), i = 0, r = f; i < r; i++) u.push(n.inArray(i, s) !== -1 ? !0 : !1);
                        else if (typeof t == "object") {
                            for (i = 0, r = f; i < r; i++) u.push(!1);
                            for (i = 0, r = t.length; i < r; i++) u[t[i]] = !0
                        } else if (t == "visible")
                            for (i = 0, r = f; i < r; i++) u.push(e[i].bVisible ? !0 : !1);
                        else if (t == "hidden")
                            for (i = 0, r = f; i < r; i++) u.push(e[i].bVisible ? !1 : !0);
                        else if (t == "sortable")
                            for (i = 0, r = f; i < r; i++) u.push(e[i].bSortable ? !0 : !1);
                        else
                            for (i = 0, r = f; i < r; i++) u.push(!0);
                        return u
                    },
                ...
                TableTools.fnGetInstance = function (n) {
                    ...
                    for (var t = 0, i = TableTools._aInstances.length; t < i; t++)
                        if (TableTools._aInstances[t].s.master && TableTools._aInstances[t].dom.table == n) return TableTools._aInstances[t];
                    return null
                };
